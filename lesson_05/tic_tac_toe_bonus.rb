...
class TTTGame
  ...
  def computer_moves
    case board.find_at_risk_marker
    when computer.marker
      board[board.find_at_risk_square] = computer.marker
      puts "At risk marker: #{board.find_at_risk_marker}"
      puts "human has a winning move at #{board.find_at_risk_square}."
    when human.marker
      board[board.find_at_risk_square] = computer.marker
      puts "At risk marker: #{board.find_at_risk_marker}"
      puts "computer has a winning move at: #{board.find_at_risk_square}."
